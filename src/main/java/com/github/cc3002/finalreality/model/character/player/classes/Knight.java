...
public class Knight extends AbstractPlayerCharacter {
  ...
  /**
   * Creates a new Knight with a name, maximum HP, defense, maximum mana and an associated turns queue.
   *
   * @param name
  ...
  public boolean canEquip(IWeapon weapon){
    return weapon.beEquippedByKnight();
  }

  /**
   * Compares two Knight objects for testing purposes.
   *
   * @param o
  ...
  /**
   * Hashes the Knight parameters for testing purposes.
   *
